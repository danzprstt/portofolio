  ...
  document.body.insertAdjacentHTML('afterbegin', `
    ...
    <nav class="navbar" id="navbar">
      ...
      <ul class="nav-menu" id="nav-menu">
        ${links}
        <li>
          <a href="https://danz-tools.vercel.app/index.html" class="nav-link" target="_blank" data-tip="Buka danz-tools">
    ...
    <footer class="site-footer">
      <div class="footer-inner">
        ...
        <nav class="footer-nav">
          ${links}
          <a href="https://danz-tools.vercel.app/index.html" target="_blank">
